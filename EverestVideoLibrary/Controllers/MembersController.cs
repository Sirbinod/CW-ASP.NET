...
namespace EverestVideoLibrary.Controllers
{
    public class MembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email,BirthDate,PhoneNumber,MemberCategoryId")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Email,BirthDate,PhoneNumber,MemberCategoryId")] Member member)
        {
            if (ModelState.IsValid)
            {
